...
<div class="row">
  <div class="col">
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item text-center"><img class="menu-image2" src="storage/3rdst.jpg" height="100" width="120"><img class="menu-image" src="storage/local.jpg" height="100" width="120"><a class="nav-link" href='/eatdrink'><strong>Eat & Drink</strong></a></li>
      <li class="list-group-item text-center"><img class="menu-image2" src="storage/jazzymural.jpg" height="100" width="120"><img class="menu-image" src="storage/shakespeare.jpg" height="100" width="120"><a class="nav-link" href='/local'><strong>Local Business</strong></a></li>
    </ul>
      </div>
  </div>
  </div>
...
<div class="row">
  <div class="col">
    ...
    <div class="card-body" id="fb" style="overflow:hidden">
    <!-- <div class="card-body"> -->
